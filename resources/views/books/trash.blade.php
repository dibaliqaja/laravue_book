...
@section('title_page','Data Books Trashed')
...
@section('content')
    ...
    <table class="table table-hover">
        ...
        <tbody>
            @foreach ($trash_book as $book)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info btn-sm" href="{{ route('books.restore', [$book->id]) }}">Restore</a>
        ...
        <tfoot>
            <tr>
                <td colspan="10">
                    {{ $trash_book->appends(Request::all())->links() }}
                </td>
            </tr>
        </tfoot>
    </table>
